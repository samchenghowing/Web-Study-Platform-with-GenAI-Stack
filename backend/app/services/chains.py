...
def check_quiz_correctness_json(user_id, llm_chain, task, answer, callbacks=[]):
    gen_system_template = f"""
    You're a programming teacher, and you have created the following question for a student:
    {task}
    Now you are programming evaluator, You will assess whether the student's answer is correct.
    ...
    {{
        ...
        "message": "Explain why the answer is correct or incorrect.",
        "hints": "Provide hints if the answer is incorrect, else return an empty string."
    }}
    ```
    ...
    **Example Responses:**
    ...
    {{
        "status": "Incorrect",
        "message": "Your answer is incorrect because you missed closing a tag.",
        "hints": "Make sure all HTML tags are properly closed."
    }}
